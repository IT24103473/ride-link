...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleApiException(ApiException ex, HttpServletRequest request) {
        ...
        // DRIVER_NOT_ELIGIBLE is the one error that carries structured detail: the driver
        // needs the full list of what to fix, not just a sentence.
        if (ex instanceof DriverNotEligibleException eligibility) {
            problem.setProperty("reasons", eligibility.getReasons());
        }
